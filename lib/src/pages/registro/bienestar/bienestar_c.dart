...
class BienestarCPage extends StatefulWidget {
  @override
  BienestarCPageState createState() => BienestarCPageState();
}

class BienestarCPageState extends State<BienestarCPage> {
  ...
  Widget _pagina1(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          gMensaje('¿Por qué te sientes así?'),
