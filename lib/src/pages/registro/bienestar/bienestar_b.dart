...
class BienestarBPage extends StatefulWidget {
  @override
  BienestarBPageState createState() => BienestarBPageState();
}

class BienestarBPageState extends State<BienestarBPage> {
  ...
  Widget _pagina1(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          gMensaje('¿Por qué te sientes bien?'),
          ...
          RaisedButton(
            ...
            child: Text(
              'Aprendí algo nuevo sobre Diabetes',
          ...
          RaisedButton(
            ...
            child: Text(
              'Me he sentido bien físicamente',
              style: TextStyle(fontSize: 15.0),
            ),
          ),
          RaisedButton(
